...
tickers_string = st.text_input('Enter all stock tickers to be included in portfolio separated by commas & WITHOUT spaces, e.g. "MA,FB,V,AMZN,JPM,BA"', 'AAPL,MSFT,META,GOOG,NFLX,AMZN')
